...
| CORE-018 | Occlusion-aware ray-posterior surface lift | in-review — implementation and disjoint karate diagnostic complete; full reciprocal arm fails its frozen 75% support floor, no-reciprocal geometry has median entropy 0.960 and remains a visually smeared volume; route rejected without threshold rescue, default off; provisional self-review complete, distinct review pending | CORE-016/017, CORE-013, BENCH-019/020, BENCH-002, ADR-0006/0032 |
| CORE-019 | Calibrated coherent-depth fusion | in-review — committed v5 four-arm diagnostic/checker complete; full changes raw depth's tradeoff at 904 fewer rows but loses PSNR/gradient/p99, fails step-zero/fixed-prefix/terminal-control and mandatory visual gates with sheets/streaks/floaters/holes; provisional self-review complete, distinct review pending, default off | CORE-016/017/018, CORE-013, BENCH-019/020, BENCH-002, ADR-0006/0032 |
