...
## Acceptance criteria
- [ ] No-grad joint RGB/coverage API, explicit safe fallback, and CPU/CUDA reference tests.
- [ ] All quality fields/rejection reasons and near-threshold/outside cases are tested.
- [ ] Frozen distinct approval, clean immutable full reports, whole-operation timings and A/A.
- [ ] Independent review, synchronized docs/ARA and full verification.
