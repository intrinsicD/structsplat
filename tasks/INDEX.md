...
| BENCH-019 | Stage-1 downstream-objective validity | partial — local matched 18-cell CUDA comparison and independent 54-view replay accepted as bounded development (C78); neither normalized family passes full materiality; general surrogate question unavailable with one capture | BENCH-001/002, CORE-012 |
