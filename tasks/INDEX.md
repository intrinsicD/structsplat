...
| FIT-025 | Reserved error-adaptive detail tail | in progress — separate physical capacity from the pre-tail active limit and compare generic versus reserved post-color detail activation at matched storage | FIT-023/024, CORE-010/011, ADR-0021 |
