...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| density | `density=variance` | 2 | +0.204 ± 0.099 | +0.006 ± 0.003 | +0.137 ± 0.098 | - | 0/0/2 | - | 0/0/2 | - | 0/0/2 | -0.003 ± 0.001 | -0.001 ± 0.001 |
| opacity | `opacity=constant` | 2 | -0.000 ± 0.001 | +0.000 ± 0.000 | +0.002 ± 0.000 | - | 0/0/2 | - | 0/0/2 | - | 0/0/2 | -0.002 ± 0.000 | +0.002 ± 0.000 |
| color_solve | `color_solve=every10` | 2 | +1.034 ± 0.031 | +0.035 ± 0.008 | +0.275 ± 0.001 | - | 0/0/2 | - | 0/0/2 | - | 0/0/2 | -0.004 ± 0.001 | +0.077 ± 0.004 |
| loss | `loss=charbonnier` | 2 | -0.001 ± 0.002 | +0.000 ± 0.000 | -0.000 ± 0.001 | - | 0/0/2 | - | 0/0/2 | - | 0/0/2 | -0.003 ± 0.001 | -0.003 ± 0.000 |
| lr_schedule | `lr_schedule=cosine` | 2 | -0.127 ± 0.435 | -0.038 ± 0.023 | -0.026 ± 0.108 | - | 0/0/2 | - | 0/0/2 | - | 0/0/2 | -0.005 ± 0.001 | -0.002 ± 0.003 |
| refine_site+refine_primitive | `refine_site=residual|refine_primitive=moment_preserving` | 2 | -0.182 ± 0.271 | -0.021 ± 0.012 | -0.470 ± 0.178 | - | 0/0/2 | - | 0/0/2 | - | 0/0/2 | -0.004 ± 0.002 | +0.001 ± 0.006 |
