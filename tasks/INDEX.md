...
| CORE-017 | Visibility-ordered alpha-shell surface lift | in-progress — exposed fixed-5k factorial numerically passes (+1.381 dB, +0.140 alpha IoU, lower gradient/leakage, zero sparse-index depth pairs), but trailing smear/double silhouettes and blur fail native review; cover-only is negative; diagnostic/default-off route not advanced | CORE-016, CORE-013, BENCH-019/020, BENCH-002, ADR-0006/0032 |
