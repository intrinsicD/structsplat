...
| BENCH-019 | Stage-1 downstream-objective validity | in-progress — accepted passive exporter/adapters available; local two-frame matched-field CUDA development experiment drafted in RTGS-019; production/executor, two prospective reviews and outcomes pending; general surrogate question remains open | BENCH-001/002, CORE-012 |
