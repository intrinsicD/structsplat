...
DURABLE_SCRIPTS: dict[str, str] = {
    ...
    "check_agent_workflow.py": "agent configuration and verification-spine checker, part of verify.sh",
    "generate_session_brief.py": "deterministic task-index execution view generator",
    "check_report_bundle.py": "standalone integrity gate for maintained portable reports",
